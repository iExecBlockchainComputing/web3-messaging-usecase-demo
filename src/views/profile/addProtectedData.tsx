  ...
  return (
    <div className="grid gap-10">
      ...
      >
        ...
        {currentStep === 1 && formData.dataType === 'telegram' && (
          <div className="grid gap-2 sm:col-span-2 lg:col-span-3">
            ...
            <div className="mt-4 grid gap-4 rounded-3xl border border-[#00115C] bg-[#00115C]/20 px-10 py-6">
              ...
              <div>
                <p>
                  Initiate a conversation with the bot @Web3Telegram_Bot to get
                  your Chat ID and receive messages.
                </p>
                <p>
                  Once open, copy your chat ID and paste it in the Telegram Chat
                  ID above.
                </p>
              </div>
              <Button
        ...
        <div className="flex justify-end gap-4 sm:col-span-2 lg:col-span-3">
          <Button
